...
document.getElementById("mentor-email").addEventListener('keyup', function() {

    let email = document.getElementById("mentor-email");
...
document.getElementById("mentor-password").addEventListener('click', function() {
...
document.getElementById("mentor-sign-in-submit").addEventListener('click', function(event) {

    let email = document.getElementById("mentor-email");
    let password = document.getElementById("mentor-password");
    let msg = document.getElementById("email-validate");
